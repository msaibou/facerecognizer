...
import { createFaceSet, getBase64, detectFace } from '../API/faceplusplus';
...
class rncamera extends Component {
    ...
    takePicture = async function () {
        if (this.camera) {
            ...
            const data = await this.camera.takePictureAsync({ quality: 0.5, width: 1080, base64: true });
            detectFace(data);
            ...
            >
              ...
              */}
                ...
                >
                    ...
                    <TouchableOpacity
                        style={[styles.flipButton, styles.picButton, { flex: 0.3, alignSelf: 'flex-end' }]}
                        onPress={() => createFaceList({ 'name': "HelloSaibou", "data": "hello world" })}

                    >
                        <Text style={styles.flipText}> create FaceList </Text>
                    </TouchableOpacity>
